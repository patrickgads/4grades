Class MainWindow
    ...
    Sub Calculate(ByVal operation As String)
    ...
    Sub DisplayResult(ByVal result As Double)
    ...
    Private Sub btnSubtract_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        Calculate(SUBTRACT)
    End Sub
    ...
    Private Sub btnMultiply_Click(ByVal sender As Object, ByVal e As RoutedEventArgs) Handles btnMultiply.Click
        Calculate(MULTIPLY)
    End Sub

    Private Sub btnDivide_Click(ByVal sender As Object, ByVal e As RoutedEventArgs) Handles btnDivide.Click
        Calculate(DIVIDE)
    End Sub
